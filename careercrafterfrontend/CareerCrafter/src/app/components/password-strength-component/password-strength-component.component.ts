...
@Component({
  ...
  templateUrl: './password-strength-component.component.html',
  styleUrls: ['./password-strength-component.component.css']
})
export class PasswordStrengthComponentComponent implements OnChanges {
  bar0!: string;
  bar1!: string;
  bar2!: string;
  bar3!: string;
